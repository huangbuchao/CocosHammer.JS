(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/CocosHammer.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4c383GideJFz6KHMTiKyX5R', 'CocosHammer', __filename);
// Script/CocosHammer.js
...
(function (exportName, undefined) {
  ...
  inherit(SwipeRecognizer, AttrRecognizer, {
    ...
    attrTest: function attrTest(input) {
      ...
      return this._super.attrTest.call(this, input) && direction & input.offsetDirection && input.distance > this.options.threshold && input.maxPointers == this.options.pointers && abs(velocity) > this.options.velocity && (input.eventType & INPUT_END || input.eventType & INPUT_CANCEL);
    },
  ...
  Hammer.defaults = {
    ...
    [RotateRecognizer, { enable: true }], [SwipeRecognizer, { direction: DIRECTION_ALL }, ["rotate"]], [PanRecognizer, { direction: DIRECTION_ALL }, ["rotate"]], [TapRecognizer, {}, ["rotate"]], [TapRecognizer, { event: "doubletap", taps: 2 }, ["rotate"]], [TapRecognizer, { event: "quadrupletap", taps: 4 }, ["rotate"]], [PressRecognizer, {}, ["rotate"]]]
  };
...
cc._RF.pop();
        ...
        //# sourceMappingURL=CocosHammer.js.map
